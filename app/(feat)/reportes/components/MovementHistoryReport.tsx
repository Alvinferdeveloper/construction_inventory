...
export default async function MovementHistoryReport({ searchParams }: MovementHistoryReportProps) {
    ...
    return (
        <div>
            <div className="flex justify-between items-center mb-4">
                <h2 className="text-2xl font-bold text-foreground">Reporte de Historial de Movimientos</h2>
                <ExportToExcel data={formattedDataForExport} fileName="reporte_movimientos" />
            </div>
            
            <MovementHistoryFilters bodegas={bodegas} materials={materials} />
