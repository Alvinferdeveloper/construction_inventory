...
CREATE TABLE `bodegas` (
  ...
  `responsableId` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `movimientos` (
  ...
  `usuarioId` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `requisas` (
  `id` int NOT NULL AUTO_INCREMENT,
  `proyecto` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `solicitanteId` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `fecha` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `estado` enum('pendiente','en_proceso','aprobada','rechazada','completada') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pendiente',
...
CREATE TABLE `users` (
  ...
  `direction` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
-- Dump completed on 2025-11-19 22:26:27
